describe('blog page should work', () => {
  ...
  it('should render lhowsam project', () => { 
    cy.contains('lhowsam.com').should('exist')
  ...
  it('should render tmtodos project', () => { 
    cy.contains('tmtodos.me - full stack todo app').should('exist')
