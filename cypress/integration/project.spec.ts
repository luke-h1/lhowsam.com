describe('project page', () => {
  ...
  it('should render lhowsam project', () => { 
    cy.get('h2').should('be.visible').contains('My Website')
  ...
  it('should render tmtodos project', () => { 
    cy.get('h2').should('be.visible').contains('tmtodos.me - full stack todo app')
  ...
  it('should render Automation project', () => {
    cy.get('h2').should('be.visible').contains('Automation')
