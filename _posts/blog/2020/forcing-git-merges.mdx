...
excerpt: easy way to force git merges
--- 
import { BlogTitle } from '../../src/templates/BlogTitle.tsx'
...
<BlogTitle>Preparing to merge</BlogTitle>
...
```
<BlogTitle>Prepare your main / master branch</BlogTitle>
...
<BlogTitle>Dress up your feature branch</BlogTitle>
...
<BlogTitle>Go in for the kill 😎</BlogTitle>
