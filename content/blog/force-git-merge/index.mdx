...
---
import CodeBlock from '../../../src/templates/CodeBlock/CodeBlock.jsx' 
...
<br />
<CodeBlock>git fetch && git status </CodeBlock>
<br />
...
<CodeBlock>git checkout feature-branch</CodeBlock> 
<CodeBlock>git merge --strategy=ours master</CodeBlock>

<br /> 
<h2>4 - Go in for the kill</h2> 

<CodeBlock>git checkout master</CodeBlock>
<CodeBlock>git merge --no-ff feature-branch</CodeBlock>
