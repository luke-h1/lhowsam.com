...
export type ProjectManyWhereInput = {
  ...
  /** All values ending with the given string. */
  githubUrl_ends_with?: InputMaybe<Scalars['String']['input']>;
  /** All values that are contained in given list. */
  ...
  /** All values not ending with the given string */
  githubUrl_not_ends_with?: InputMaybe<Scalars['String']['input']>;
  /** All values that are not contained in given list. */
  githubUrl_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  /** All values not starting with the given string. */
  githubUrl_not_starts_with?: InputMaybe<Scalars['String']['input']>;
  /** All values starting with the given string. */
  githubUrl_starts_with?: InputMaybe<Scalars['String']['input']>;
  id?: InputMaybe<Scalars['ID']['input']>;
  /** All values containing the given string. */
  id_contains?: InputMaybe<Scalars['ID']['input']>;
  /** All values ending with the given string. */
...
export type TagCreateInput = {
  cll9jkvyy193x01um5c1jfj3n?: InputMaybe<PostCreateManyInlineInput>;
  cll9kyjrh193r01tc6ag98n06?: InputMaybe<ProjectCreateManyInlineInput>;
  createdAt?: InputMaybe<Scalars['DateTime']['input']>;
  slug: Scalars['String']['input'];
  title: Scalars['String']['input'];
  updatedAt?: InputMaybe<Scalars['DateTime']['input']>;
...
export type TagUpdateInput = {
  cll9jkvyy193x01um5c1jfj3n?: InputMaybe<PostUpdateManyInlineInput>;
  cll9kyjrh193r01tc6ag98n06?: InputMaybe<ProjectUpdateManyInlineInput>;
  slug?: InputMaybe<Scalars['String']['input']>;
  title?: InputMaybe<Scalars['String']['input']>;
};
...
export type HighlightedProjectsQueryVariables = Exact<{ [key: string]: never }>;

export type HighlightedProjectsQuery = {
  __typename?: 'Query';
  projects: Array<{
    __typename?: 'Project';
    id: string;
...
export const ProjectFragmentFragmentDoc = `
  ...
  githubUrl
    ...
    `;
export const HighlightedProjectsDocument = `
    query HighlightedProjects {
  projects(where: {title_in: ["My website", "Storify", "Automation"]}) {
    ...ProjectFragment
  }
}
    ${ProjectFragmentFragmentDoc}`;
export const useHighlightedProjectsQuery = <
  TData = HighlightedProjectsQuery,
  TError = unknown,
>(
  dataSource: { endpoint: string; fetchParams?: RequestInit },
  variables?: HighlightedProjectsQueryVariables,
  options?: UseQueryOptions<HighlightedProjectsQuery, TError, TData>,
) =>
  useQuery<HighlightedProjectsQuery, TError, TData>(
    variables === undefined
      ? ['HighlightedProjects']
      : ['HighlightedProjects', variables],
    fetcher<HighlightedProjectsQuery, HighlightedProjectsQueryVariables>(
      dataSource.endpoint,
...
export const PostSlugsDocument = `
  ...
  posts {
    ...
    `;
export const usePostSlugsQuery = <TData = PostSlugsQuery, TError = unknown>(
  dataSource: { endpoint: string; fetchParams?: RequestInit },
  variables?: PostSlugsQueryVariables,
  options?: UseQueryOptions<PostSlugsQuery, TError, TData>,
) =>
  useQuery<PostSlugsQuery, TError, TData>(
    variables === undefined ? ['PostSlugs'] : ['PostSlugs', variables],
    fetcher<PostSlugsQuery, PostSlugsQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
      PostSlugsDocument,
      variables,
...
export const ProjectSlugsDocument = `
  ...
  projects {
    ...
    `;
export const useProjectSlugsQuery = <
  TData = ProjectSlugsQuery,
  TError = unknown,
>(
  dataSource: { endpoint: string; fetchParams?: RequestInit },
  variables?: ProjectSlugsQueryVariables,
  options?: UseQueryOptions<ProjectSlugsQuery, TError, TData>,
) =>
  useQuery<ProjectSlugsQuery, TError, TData>(
    variables === undefined ? ['ProjectSlugs'] : ['ProjectSlugs', variables],
    fetcher<ProjectSlugsQuery, ProjectSlugsQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
...
export const useRecentPostsQuery = <TData = RecentPostsQuery, TError = unknown>(
  ...
  useQuery<RecentPostsQuery, TError, TData>(
    variables === undefined ? ['RecentPosts'] : ['RecentPosts', variables],
