...
seoDescription: 'A TypeScript class can only extend one parent. Here is how I used mixins to share fields across several TypeGraphQL input types without duplicating them.'
