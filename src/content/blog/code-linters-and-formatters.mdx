...
seoDescription: 'Linters flag bugs and bad practices, formatters rewrite your code to match a style guide. What each one is actually for and how I set both up on a project.'
