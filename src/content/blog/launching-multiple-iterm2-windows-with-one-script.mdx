...
seoDescription: 'As a project grows, starting your local environment gets tedious. How I went from running four commands to one to start a project with multiple sub-projects.'
