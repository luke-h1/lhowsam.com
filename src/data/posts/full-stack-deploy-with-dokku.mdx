...
Assign the port to the API name. This should match whatever you've exposed in your Docker image
...
Now that we've assigned a domain name, configured the correct port, we can enable let's encrypt:
