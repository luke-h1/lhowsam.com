...
date: "2021-01-26"
tags: ['nextjs', 'typescript', 'jest', 'testing']
summary: Sharing my thoughts on how to get setup with jest + typescript on Next JS
---

Recently I tried Next and started to enjoy developing sites with it. I've found next js to have a smooth development process, the file structure to be well organized & the fast refresh dev server to be blazingly fast. In addition to this you will get <a href='https://dev.to/prateekvijayvergiya/server-side-rendering-with-next-js-1896' target='_blank'>server side rendering out the box</a> which means you can update content without re-building your project and your site can be crawled easily due to next sending down pre-rendered HTML for each page that a user visits
...
This will create a new next app in the current directory
