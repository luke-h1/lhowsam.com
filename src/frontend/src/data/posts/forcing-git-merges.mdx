...
intro: 'Isolating features into seperate branches is a really common practice for most developers. By seperating features & bug fixes you can avoid a lot of problems and keep your branches clean.'
...
Before you touch anything ensure that your local repository (hotfix branch) is up to date with the latest changes from your remote origin with:
